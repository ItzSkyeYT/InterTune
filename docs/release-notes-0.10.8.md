...
A small release: three new things, the Quick picks row behaving itself, and the interface work that was ready. Nothing here changes unless you use it.
