...
`InterTune-0.10.1-8-core-release-78.apk`, signed with my own key, which is why Android treats it as a separate app from the official OuterTune. It installs alongside OuterTune rather than updating it. To move your library across, use **Settings → Backup and restore**.
