...
object EngineTuning {
    ...
    val entries: List<Tunable> = listOf(
        ...
        Tunable("exploreSpan", "Explore share added at adventurousness 100", 0.75) { p, v -> p.copy(exploreSpan = v) },
        Tunable("dialFreesReplay", "How much of Again and Rediscover the dial hands to Related", 0.8) { p, v -> p.copy(dialFreesReplay = v) },
